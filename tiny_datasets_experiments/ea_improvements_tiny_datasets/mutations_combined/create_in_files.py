...
Mutators_to_alterate = [
	["ea_global_activation_mutation", "ea_global_low_deg_mutation",
	"ea_global_random_mutation",
	"ea_global_low_spread", "ea_global_low_additional_spread"],
	["ea_local_activation_mutation", 'ea_local_neighbors_second_degree_mutation',
	...
	["ea_global_activation_mutation", "ea_local_activation_mutation"]
]
names = ["global_mutations", "local_mutations", "activation_mutations"]
mutations_names = {}
for m, n in zip(Mutators_to_alterate, names):
	mutations_names[str(m)] = n
...
for config in configs:
	...
	for var, var_values in zip(variables, values):
		...
		for var_value in var_values:
			...
			var_value = mutations_names[str(var_value)]
