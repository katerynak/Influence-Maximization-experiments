...
Mutators_to_alterate = ["ea_local_activation_mutation", 'ea_local_neighbors_second_degree_mutation',  "ea_local_neighbors_second_degree_mutation_emb", "ea_local_embeddings_mutation",
								 "ea_local_neighbors_random_mutation", "ea_local_neighbors_spread_mutation",
								 "ea_local_additional_spread_mutation", "ea_local_approx_spread_mutation", "ea_global_activation_mutation", "ea_global_low_deg_mutation", "ea_global_random_mutation",
								 "ea_global_low_spread", "ea_global_low_additional_spread"]
Mutators_to_alterate = [[m] for m in Mutators_to_alterate]
variables = ['mutators_to_alterate']
values = [Mutators_to_alterate]
...
for config in configs:
	...
	for var, var_values in zip(variables, values):
		...
		for var_value in var_values:
			...
			args["node2vec_file"] = "../experiments/node2vec_embeddings_training_tiny_datasets/out/{}/dimensions_32/seed_4_exp_" \
									"in/repetition_0/embeddings.emb".format(config[0])
