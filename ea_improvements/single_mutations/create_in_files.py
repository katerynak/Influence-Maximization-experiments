...
Global_mutation = ["ea_global_activation_mutation", "ea_global_low_deg_mutation",
...
variables = ['global_mutation_operator']
values = [Global_mutation]
...
for config in configs:
	...
	for var, var_values in zip(variables, values):
		...
		for var_value in var_values:
			...
			in_dir = "./in/" + config[0] + "/" + config[1] + "/" + str(config[2]) + "/{}".format(var_value)
