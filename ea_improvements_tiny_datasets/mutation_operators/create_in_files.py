...
Mutators_to_alterate = ["ea_local_activation_mutation", 'ea_local_neighbors_second_degree_mutation', "ea_local_neighbors_second_degree_mutation_emb", "ea_local_embeddings_mutation",
								 ...
								 "ea_local_additional_spread_mutation", "ea_local_approx_spread_mutation", "ea_global_activation_mutation", "ea_global_low_deg_mutation", "ea_global_random_mutation", "ea_differential_evolution_mutation",
								 "ea_global_low_spread", "ea_global_low_additional_spread", "ea_global_subpopulation_mutation"]
