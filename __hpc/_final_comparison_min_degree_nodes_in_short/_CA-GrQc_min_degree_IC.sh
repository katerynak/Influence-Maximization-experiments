...
python3 experiments.py --exp_dir=../experiments/final_comparison/min_degree_nodes/in/CA-GrQc/min_degree/IC --hpc=True & python3 experiments.py --exp_dir=../experiments/final_comparison/min_degree_nodes/in/CA-GrQc/min_degree/WC --hpc=True & 
wait