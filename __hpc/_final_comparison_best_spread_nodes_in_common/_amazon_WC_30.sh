...
python3 experiments.py --exp_dir=../experiments/final_comparison/best_spread_nodes/in/amazon/WC/30 --hpc=True & python3 experiments.py --exp_dir=../experiments/final_comparison/best_spread_nodes/in/amazon/WC/50 --hpc=True & python3 experiments.py --exp_dir=../experiments/final_comparison/best_spread_nodes/in/wiki/IC/10 --hpc=True & python3 experiments.py --exp_dir=../experiments/final_comparison/best_spread_nodes/in/wiki/IC/40 --hpc=True & 
wait