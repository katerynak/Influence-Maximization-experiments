...
python3 experiments.py --exp_dir=../experiments/smart_initialization/community_detection/in/wiki/smart_initialization_percentage/IC/community_degree --hpc=True
