...
python3 experiments.py --exp_dir=../experiments/smart_initialization/comparison_mixed_methods/in/CA-GrQc/smart_initialization_percentage/WC/degree/0.9 --hpc=True
