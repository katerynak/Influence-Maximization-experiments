...
python3 experiments.py --exp_dir=../experiments/embeddings_testing/in/wiki/node2vec_file/WC/50/_experiments_node2vec_embeddings_training_out_wiki_iter_dimensions_128_1_seed_4_exp_in_repetition_0_embeddings_iter_1__emb --hpc=True
