...
python3 experiments.py --exp_dir=../experiments/embeddings_testing/in/wiki/node2vec_file/IC/20/_experiments_node2vec_embeddings_training_out_wiki_iter_dimensions_4_1_seed_2_exp_in_repetition_0_embeddings_iter_1__emb --hpc=True
