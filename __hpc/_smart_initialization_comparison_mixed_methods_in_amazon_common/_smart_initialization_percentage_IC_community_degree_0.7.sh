...
python3 experiments.py --exp_dir=../experiments/smart_initialization/comparison_mixed_methods/in/amazon/smart_initialization_percentage/IC/community_degree/0.7 --hpc=True
