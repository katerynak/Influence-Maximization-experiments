...
python3 experiments.py --exp_dir=../experiments/final_comparison/single_mutations/in/CA-GrQc/WC/30 --hpc=True & python3 experiments.py --exp_dir=../experiments/final_comparison/single_mutations/in/CA-GrQc/WC/50 --hpc=True & 
wait