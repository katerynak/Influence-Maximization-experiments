...
python3 experiments.py --exp_dir=../experiments/ea_improvements/global_search_methods/in/wiki/global_mutation_operator/IC --hpc=True & python3 experiments.py --exp_dir=../experiments/ea_improvements/global_search_methods/in/wiki/global_mutation_operator/WC --hpc=True & 
wait