...
python3 experiments.py --exp_dir=../smart_initialization/community_detection/in/barabasi_albert/smart_initialization_percentage/IC/community_degree --hpc=True
