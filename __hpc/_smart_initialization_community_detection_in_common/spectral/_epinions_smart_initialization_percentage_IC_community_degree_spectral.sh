...
python3 experiments.py --exp_dir=../experiments/smart_initialization/community_detection/in/epinions/smart_initialization_percentage/IC/community_degree_spectral --hpc=True
