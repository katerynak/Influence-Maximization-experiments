...
python3 experiments.py --exp_dir=../experiments/smart_initialization/community_detection/in/barabasi_albert/population_size/IC/community_degree_spectral --hpc=True
