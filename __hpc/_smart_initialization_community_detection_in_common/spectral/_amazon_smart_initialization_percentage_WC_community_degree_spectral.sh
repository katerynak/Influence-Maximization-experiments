...
python3 experiments.py --exp_dir=../experiments/smart_initialization/community_detection/in/amazon/smart_initialization_percentage/WC/community_degree_spectral --hpc=True
