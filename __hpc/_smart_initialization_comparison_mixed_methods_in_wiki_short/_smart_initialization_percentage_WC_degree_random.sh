...
python3 experiments.py --exp_dir=../experiments/smart_initialization/comparison_mixed_methods/in/wiki/smart_initialization_percentage/WC/degree_random --hpc=True
