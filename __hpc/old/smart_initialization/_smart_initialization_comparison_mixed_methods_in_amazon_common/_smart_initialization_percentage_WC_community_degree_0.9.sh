...
python3 experiments.py --exp_dir=../experiments/smart_initialization/comparison_mixed_methods/in/amazon/smart_initialization_percentage/WC/community_degree/0.9 --hpc=True
