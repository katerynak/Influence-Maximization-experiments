...
python3 experiments.py --exp_dir=../experiments/smart_initialization/community_detection/in/barabasi_albert/smart_initialization_percentage/IC/community --hpc=True
