...
python3 experiments.py --exp_dir=../experiments/ea_improvements/min_degree_nodes/in/CA-GrQc/min_degree/WC/30 --hpc=True & 
python3 experiments.py --exp_dir=../experiments/ea_improvements/min_degree_nodes/in/CA-GrQc/min_degree/WC/50 --hpc=True & 
